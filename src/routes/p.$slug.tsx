...
function Page() {
  ...
  if (q.isLoading) {
    return (
      <PageShell eyebrow="eticketo.eu" title="Načítavam…" description="">
  ...
  const page = q.data;
  return (
    <PageShell eyebrow="eticketo.eu" title={page.title} description={page.meta_description ?? ""}>
