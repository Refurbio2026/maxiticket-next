...
function AdminDashboard() {
  ...
  const stats = [
    {
      label: "Dnešné tržby",
      value: kpi ? fmtEur(kpi.today_revenue) : "—",
      icon: TrendingUp,
      tone: "primary",
    },
    {
      label: "Vstupenky (dnes)",
      value: kpi ? fmtNum(kpi.today_tickets) : "—",
      icon: Ticket,
      tone: "accent",
    },
    {
      label: "Aktívne podujatia",
      value: kpi ? fmtNum(kpi.active_events) : "—",
      icon: CalendarDays,
      tone: "success",
    },
    {
      label: "Organizátori",
      value: kpi ? fmtNum(kpi.organizers) : "—",
      icon: Users,
      tone: "muted",
    },
    {
      label: "Refundácie",
      value: kpi ? fmtNum(kpi.pending_refunds) : "—",
      icon: RotateCcw,
      tone: "destructive",
    },
  ];
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h1 className="font-display text-3xl font-bold tracking-tight">Prehľad vipky.sk</h1>
                  ...
                  >
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge
                          variant="outline"
                          className={`${statusTone[o.status] || ""} text-[10px]`}
                        >
