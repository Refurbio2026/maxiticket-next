      ...
      cta={
        <>
          <Button asChild className="bg-gradient-flame text-primary-foreground shadow-glow">
            <Link to="/contact">
              Kontaktovať marketingový tím <ArrowRight className="size-4 ml-1.5" />
            </Link>
          </Button>
    ...
    >
      <FeatureGrid
        items={[
          {
            icon: Megaphone,
            title: "Propagácia podujatí",
            description: "Featured pozície na homepage, v kategóriách a v mestských sekciách.",
          },
          {
            icon: Share2,
            title: "Sociálne siete",
            description: "Promo posty na Instagrame, Facebooku a TikToku v vipky.sk kanáloch.",
          },
          {
            icon: Mail,
            title: "Newsletter",
            description: "Cielené kampane na 120 000+ aktívnych odberateľov podľa miest a žánrov.",
          },
          {
            icon: Handshake,
            title: "Partnerské kampane",
            description: "Cross-promo s ďalšími podujatiami, značkami a mediálnymi partnermi.",
          },
          {
            icon: Tv,
            title: "Mediálna podpora",
            description: "Tlačové správy, rozhlasové spoty a externé PPC kampane.",
          },
          {
            icon: Sparkles,
            title: "Kampane na mieru",
            description: "Strategický plán, kreatíva, A/B testovanie a reporting v reálnom čase.",
          },
        ]}
      />
        ...
        <div className="relative grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Od jednorázovej propagácie po celoročnú spoluprácu. Vyberte si formát, ktorý sedí
              vašej značke.
            </p>
          ...
          <div className="space-y-3">
            {[
              { name: "Štart", price: "od 290 €", desc: "Pre menšie podujatia a kluby." },
              {
                name: "Rast",
                price: "od 890 €",
                desc: "Festival, viacdňové podujatie, séria koncertov.",
              },
              {
                name: "Premium",
                price: "od 2 490 €",
                desc: "Veľké open-air a celoštátne kampane.",
              },
            ].map((p) => (
              <div
                key={p.name}
                className="flex items-center justify-between p-4 rounded-xl bg-background/50 border border-border/60"
              >
                <div>
