...
function MarketingPage() {
  return (
    <PageShell
      ...
      description="Propagujte vaše podujatia naprieč MAXITICKET sieťou, sociálnymi sieťami, newsletterom a partnerskými kanálmi. Mediálna podpora a kampane na mieru."
      cta={
        <>
    ...
    >
      <FeatureGrid
        items={[
          ...
          { icon: Share2, title: "Sociálne siete", description: "Promo posty na Instagrame, Facebooku a TikToku v MAXITICKET kanáloch." },
