...
const cats = [
  {
    ...
    slug: "koncerty",
    count: 1240,
    hue: "from-orange-500/20 to-amber-500/10",
  },
  {
    icon: Disc3,
    label: "Festivaly",
    slug: "festivaly",
    count: 86,
    hue: "from-pink-500/20 to-orange-500/10",
  },
  {
    icon: Trophy,
    label: "Šport",
  ...
  },
  {
    ...
    slug: "konferencie",
    count: 64,
    hue: "from-emerald-500/20 to-cyan-500/10",
  },
  {
    icon: Lightbulb,
    label: "Workshopy",
  ...
  },
  {
    ...
    slug: "kluby",
    count: 287,
    hue: "from-fuchsia-500/20 to-purple-500/10",
  },
];
            ...
            >
              ...
              <div className="relative">
                <div className="size-12 rounded-xl bg-background/40 backdrop-blur grid place-items-center mb-4 group-hover:bg-gradient-flame transition-all duration-300">
                  <c.icon
                    className="size-5 group-hover:text-primary-foreground transition-colors"
                    strokeWidth={2}
                  />
                </div>
